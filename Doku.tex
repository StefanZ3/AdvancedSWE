...
%https://www.cassini.de/inspire/agile-vs-klassisch
%\cite{cassini_agile_2024}

%Evolutionäre Ansätze
%https://chaosverbesserer.de/blog/2017/01/28/warum-scrum-und-andere-methoden-nicht-der-pfad-zur-erleuchtung-sind/
%\cite{schonfeld_warum_2024}

%Alternative Rollen und Verantwortlichkeiten
%https://www.dasscrumteam.com/de/blog/raci-matrix-und-ihre-agile-alternative
%\cite{beck_raci-matrix_2022}

%Anpassbare Tools und Technologien
%https://omr.com/de/reviews/contenthub/beste-agile-tools
%\cite{marx_top_2024}

%Design Thinking und kreative Ansätze
%\cite{simschek_agilitat_2023}
