...
%https://blueant.de/de/ressourcen/projektmanagement-wissen/agiles-oder-klassisches-projektmanagement/
\subsection{Unterschied zur klassischen Arbeitsweise}
Die klassischen und agilen Methoden unterscheiden sich grundlegend in ihrer Herangehensweise an Projekten. Klassische Modelle wie das Wasserfallmodell basieren auf klar strukturierten Vorgehensweisen, während sich agile Methoden durch Flexibilität und iterative Prozesse auszeichnen.\\
%https://www.consileon.de/agilitaet-mehr-als-nur-ein-buzzword/
\begin{figure}[h]
\centering
